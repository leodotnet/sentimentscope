...
java -cp bin -Xmx16g com.nlp.targetedsentiment.util.TargetSentimentGlobal sentimentspan_latent 1000 $l2 $beginIndex $endIndex $lang weightnotpush $task $NElen WITHOUT_HIDDEN_SENTIMENT> $logfile 2>&1
