package com.nlp.targetedsentiment.f.baseline;
...
import com.nlp.targetedsentiment.f.TargetSentimentFeatureManager.WORD_FEATURE_TYPES;
import com.nlp.targetedsentiment.f.baseline.PipeTargetSentimentCompiler.*;
