...
public class PipeTargetSentimentLearner {
	...
	public static String in_path = "experiments//sentiment//model//baseline_pipeline//Twitter_";
	public static String out_path = "experiments//sentiment//model//baseline_pipeline//Twitter_";
	...
	public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException {
		...
		if (args.length > 5)
		{
			...
			{
				weightpush = true;
				TargetSentimentGlobal.WEIGHT_PUSH = weightpush;
			}
		}
		...
		in_path = in_path + lang + "//temp//";
		out_path = out_path + lang + "//" + subpath + "//";
		feature_file_path = "data//Twitter_" + lang + "//feature_files//";
