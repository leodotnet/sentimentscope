...
mkdir experiments/sentiment/model/baseline_collapse/Twitter_$lang/$task
...
python scripts/sentiment.py $beginIndex $endIndex baseline_collapse $lang $task N >> $logfile
date >> email_succ.txt
