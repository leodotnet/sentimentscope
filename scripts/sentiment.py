...
OutputPath = 'experiments//sentiment//model//' + model + '//Twitter_' + lang + '//' + subpath + '//'
...
for i in range(inbound,outbound+1):
    print("python scripts//calc_accuracy_all.py " + GoldPath + "test.%d.coll " % (i) + OutputPath + "result.%d.out " % (i)  + showdetail + ' ' + useAspect + "  >> " + OutputPath + "result.prediction.summary.all ")
    subprocess.call("python scripts//calc_accuracy_all.py " + GoldPath + "test.%d.coll " % (i) + OutputPath + "result.%d.out " % (i)  + showdetail + ' '  + useAspect + "  >> " + OutputPath + "result.prediction.summary.all ", shell=True)
...
#print("type " + OutputPath + "result.prediction.summary")
