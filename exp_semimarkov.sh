...
java -Xmx32g -jar sentimentspan.jar semimarkov_nonlatent 1000 $l2 $beginIndex $endIndex $lang weightnotpush $task $NElen > $logfile 2>&1

python scripts/sentiment.py $beginIndex $endIndex semimarkov_nonlatent $lang $task N
